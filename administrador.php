     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Bienvenido Administrador</a>
            </div>
            <!-- /.navbar-header -->
            <ul class="nav navbar-nav navbar-right">
			    ...
			    <li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li><a href="#"><i class="fa fa-comments"></i> Comments <span class="label label-warning"></span></a></li>
						<li class="dropdown-menu-header text-center">
						...
						<li class="divider"></li>
						<li class="m_2"><a href="#"><i class="fa fa-shield"></i> Login</a></li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="index.php"><i class="fa fa-dashboard fa-fw nav_icon"></i>Inicio</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-laptop nav_icon"></i>Productos<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="grids.html">Listar Productos</a>
                                </li>
								<li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="basic_tables.php">Listar Estudiantes</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
